...
class TrackRecyclerAdpater (var data: MutableList<TrackListResponse>, val c: Activity, val  tagData :String) :
    RecyclerView.Adapter<TrackRecyclerAdpater.ViewHolder>() {
